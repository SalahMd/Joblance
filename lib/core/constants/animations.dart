...
class AppAnimations {
  ...
  static LottieBuilder noInternet = Lottie.asset(
    path + "no_internet.json",
  );
  static LottieBuilder loadings =
      Lottie.asset(path + "confirmloading.json", width: 120.w, height: 120.h);
  static LottieBuilder loadingDots = Lottie.asset(
    path + "loadingDots.json",
  );
  static LottieBuilder serverError = Lottie.asset(path + "server_error.json",repeat: false);
}
