...
import 'package:joblance/features/job_application/presentation/screens/job_application_page.dart';

class JobApplicantDesign extends StatelessWidget {
  final String name, email, major, date, image, id, experience;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.to(JobApplicationPage(id: id));
      },
      child: Container(
